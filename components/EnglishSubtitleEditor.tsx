...
interface EnglishSubtitleEditorProps {
    content: string;
...
const EnglishSubtitleEditor: React.FC<EnglishSubtitleEditorProps> = ({ 
    content, 
    onContentChange,
    isLoading,
    onGenerate,
    ...
    const editorId = "english-subtitle-editor";
    const label = "English Subtitle";
        ...
        <div className="flex flex-col flex-grow w-full">
            ...
            <div className="relative w-full">
                <textarea
                    ...
                    placeholder="Click 'Generate' to create subtitles (max 40 chars/line) from the English script, or open a .txt file."
...
export default EnglishSubtitleEditor;
