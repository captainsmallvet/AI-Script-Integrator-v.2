...
const VideoTagsEditor: React.FC<VideoTagsEditorProps> = ({ 
    content, 
    onContentChange, 
    isLoading,
    onGenerate,
    ...
    const editorId = "video-tags-editor";
    const label = "YouTube Video Clip Tags 500 charactors";
        ...
        <div className="flex flex-col flex-grow w-full">
            ...
            <div className="relative w-full">
                <textarea
                    ...
                    placeholder="Click 'Generate' to create optimized video tags (~500 chars)..."
