...
interface YouTubeDescriptionEditorProps {
    content: string;
...
const YouTubeDescriptionEditor: React.FC<YouTubeDescriptionEditorProps> = ({ 
    content, 
    onContentChange, 
    onOpen,
    onSave,
    ...
    const editorId = "youtube-description-editor";
    const label = "YouTube Channel Description";
...
export default YouTubeDescriptionEditor;