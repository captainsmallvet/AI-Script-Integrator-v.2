...
interface YouTubeTagsEditorProps {
    content: string;
...
const YouTubeTagsEditor: React.FC<YouTubeTagsEditorProps> = ({ 
    content, 
    onContentChange, 
    onOpen,
    onSave,
    ...
    const editorId = "youtube-tags-editor";
    const label = "YouTube Channel Tags";
        ...
        <div className="flex flex-col flex-grow w-full">
            ...
            <div className="relative w-full">
                <textarea
                    ...
                    placeholder="Enter channel tags here..."
...
export default YouTubeTagsEditor;
