...
interface Description5000EditorProps {
    content: string;
...
const Description5000Editor: React.FC<Description5000EditorProps> = ({ 
    content, 
    onContentChange, 
    isLoading,
    onGenerate,
    ...
    const editorId = "description-5000-editor";
    const label = "YouTube Video Clip Description 5,000 charactors";
        ...
        <div className="flex flex-col flex-grow w-full">
            ...
            <div className="relative w-full">
                <textarea
                    ...
                    placeholder="Click 'Generate' to create a comprehensive video description..."
...
export default Description5000Editor;
