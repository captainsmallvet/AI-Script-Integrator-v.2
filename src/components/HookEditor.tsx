...
const HookEditor: React.FC<HookEditorProps> = ({ 
    ...
    const editorId = "hook-editor";
    const label = "ท่อน Hook สำหรับ YouTube Video Clip";
    ...
    return (
        <div className="flex flex-col flex-grow w-full">
            ...
            <p className="text-yellow-400 text-sm mb-4">
                *** อย่าลืมเพิ่มใน 'English audio script no timestamp' ***
            </p>
            ...
            <div className="relative w-full">
                <textarea
                    ...
                    placeholder="Click 'Generate' to create a viral hook based on your channel and script analysis..."
