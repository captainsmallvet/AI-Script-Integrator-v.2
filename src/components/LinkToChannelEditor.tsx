...
interface LinkToChannelEditorProps {
    content: string;
...
const LinkToChannelEditor: React.FC<LinkToChannelEditorProps> = ({ 
    content, 
    onContentChange, 
    onOpen,
    onSave,
    ...
    const editorId = "link-to-channel-editor";
    const label = "Link to channel";
        ...
        <div className="flex flex-col flex-grow w-full">
            ...
            <div className="relative w-full">
                <textarea
                    ...
                    placeholder="Enter channel links here..."
...
export default LinkToChannelEditor;
